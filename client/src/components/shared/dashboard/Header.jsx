  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <div
        className={
          showMenu
            ? 'absolute left-8 top-[4.15rem] lg:hidden w-56 h-64 py-4 px-6 bg-transparentBlue/95 duration-200 ease-in'
            : 'absolute -left-80 top-[4.15rem] lg:hidden w-56 h-64 py-4 px-6 bg-transparentBlue/95 duration-200 ease-in'
        }
      >
      ...
      <div className="flex items-center gap-10">
        ...
        <div
          className="hidden md:flex items-center gap-4 hover:cursor-pointer"
      ...
      {showPopup ? (
        <div
          ...
          id="popup"
        >
          <div className="absolute right-16 top-11 h-20 w-36 p-3 bg-white shadow-sm rounded-md flex flex-col gap-y-3">
